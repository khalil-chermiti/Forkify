    ...
    const markup = `
        ...
        <div class="recipe__details">
            <div class="recipe__info">
                ...
                <span class="recipe__info-data recipe__info-data--minutes">${recipe.avgTime}</span>
        ...
        <div class="recipe__directions">
            ...
            <a class="btn-small recipe__btn" href="${recipe.recipe}" target="_blank">
...
// update the recipe ingredients on the UI 
